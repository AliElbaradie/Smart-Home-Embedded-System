 ...
 * Author: aliel
 *
 * Created on 27. August 2024, 05:53
 */
...
Std_ReturnType EUSART_SYNC_MASTER_Tx_Init(const usart_sync_t *_eusart){
    ...
    if(NULL == _eusart){
        ...
        /* 9 Bits Config */
        TXSTAbits.TX9 = EUSART_SYNC_9Bit_TX_DISABLE;
