...
# 110 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *_pin_config){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) == _pin_config) || (_pin_config->pin > 8 -1)){
        ret = (Std_ReturnType)0x00;
...
# 183 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port, logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port > 5 -1){
        ret = (Std_ReturnType)0x00;
...
# 201 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port, logic_t *logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 218 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port > 5 -1){
        ret = (Std_ReturnType)0x00;
