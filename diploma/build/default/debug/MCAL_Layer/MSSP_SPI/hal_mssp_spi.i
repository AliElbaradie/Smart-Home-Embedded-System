# 1 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.c" 2
...
# 1 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h" 1
# 12 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h"
# 1 "MCAL_Layer/MSSP_SPI/mssp_spi_cfg.h" 1
# 12 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h" 2

# 1 "MCAL_Layer/MSSP_SPI/../mcal_std_types.h" 1
# 13 "MCAL_Layer/MSSP_SPI/../mcal_std_types.h"
# 1 "MCAL_Layer/MSSP_SPI/../std_libraries.h" 1
# 13 "MCAL_Layer/MSSP_SPI/../std_libraries.h"
...
# 13 "MCAL_Layer/MSSP_SPI/../std_libraries.h" 2
...
# 14 "MCAL_Layer/MSSP_SPI/../std_libraries.h" 2
...
# 15 "MCAL_Layer/MSSP_SPI/../std_libraries.h" 2
# 13 "MCAL_Layer/MSSP_SPI/../mcal_std_types.h" 2

# 1 "MCAL_Layer/MSSP_SPI/../compiler.h" 1
# 13 "MCAL_Layer/MSSP_SPI/../compiler.h"
...
# 13 "MCAL_Layer/MSSP_SPI/../compiler.h" 2
# 14 "MCAL_Layer/MSSP_SPI/../mcal_std_types.h" 2
...
# 13 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h" 2


# 1 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio.h" 1
# 14 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/MSSP_SPI/../GPIO/../device_config.h" 1
# 14 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/MSSP_SPI/../GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 15 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h" 2

# 1 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_interrupt_config.h" 1
# 15 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_interrupt_config.h" 2
# 54 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/MSSP_SPI/../Interrupt/mcal_internal_interrupt.h" 2
# 16 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h" 2
# 69 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.h"
typedef enum {
...
typedef struct {
    ...
    pin_config_t slave_1_choose_pin;
    pin_config_t SDO_pin;
    pin_config_t SS_pin;
    pin_config_t clock_pin;
    spi_select_mode_t spi_selected_mode;
    uint8 SPI_Master_or_Slave : 1;
    uint8 SPI_clock_polarity_select : 1;
    uint8 SPI_output_data_clock_edge : 1;
    uint8 SPI_input_data_sample : 1;
    uint8 reserved : 4;
}spi_object_t;
...
# 8 "MCAL_Layer/MSSP_SPI/hal_mssp_spi.c" 2


static void (*SPI_InterruptHandler_Callbak)(void) = ((void*)0);
...
Std_ReturnType SPI_initialize(const spi_object_t *_spi){
    ...
    if(((void*)0) == _spi){
        ...
        if(1 == _spi->SPI_clock_polarity_select){
            (SSPCON1bits.CKP = 1);
        }else if(0 == _spi->SPI_clock_polarity_select){
            (SSPCON1bits.CKP = 0);
        }else{
        ...
        if(1 == _spi->SPI_output_data_clock_edge){
            (SSPSTATbits.CKE = 1);
        }else if(0 == _spi->SPI_output_data_clock_edge){
            (SSPSTATbits.CKE = 0);
        }else{
        ...
        if(1 == _spi->SPI_input_data_sample){
            (SSPSTATbits.SMP = 1);
        }else if(0 == _spi->SPI_input_data_sample){
            (SSPSTATbits.SMP = 0);
        }else{
