...
# 33 "MCAL_Layer/CCP/../GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 15 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h"
...
Std_ReturnType CCP_Capture_Start(const ccp_t *_ccp_obj){
    ...
    if(((void*)0) == _ccp_obj){
        ...
        if(CCP1_INST == _ccp_obj->ccp_inst){
            CCP1CONbits.CCP1M = _ccp_obj->ccp_mode_variant;
        }
        else if(CCP2_INST == _ccp_obj->ccp_inst){
            CCP2CONbits.CCP2M = _ccp_obj->ccp_mode_variant;
        }
        else{ }
        ret = (Std_ReturnType)0x01;
    }
