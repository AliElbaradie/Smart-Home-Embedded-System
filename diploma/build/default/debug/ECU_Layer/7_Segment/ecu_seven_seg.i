...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../compiler.h"
...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../compiler.h" 2
...
# 33 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 14 "ECU_Layer/7_Segment/ecu_seven_seg.h" 2
...
# 8 "ECU_Layer/7_Segment/ecu_seven_seg.c" 2
...
Std_ReturnType seven_segment_initialize(const seg_t *seg){
    ...
    if(((void*)0) == seg){
        ...
        gpio_pin_initialize(&(seg->seven_seg_pins[0]));
        gpio_pin_initialize(&(seg->seven_seg_pins[1]));
        gpio_pin_initialize(&(seg->seven_seg_pins[2]));
        gpio_pin_initialize(&(seg->seven_seg_pins[3]));
