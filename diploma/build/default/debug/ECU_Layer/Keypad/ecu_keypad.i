...
# 13 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../compiler.h"
...
uint8 button_matrics[4][4] = {{'7','8','9','/'},
                                                                {'4','5','6','*'},
                                                                {'1','2','3','-'},
                                                                {'#','0','=','+'}};
...
Std_ReturnType keypad_initialize(const keypad_t *_keypad_object){
    ...
    if(((void*)0) == _keypad_object){
        ...
        for(l_colomn_counter = 0; l_colomn_counter < 4; l_colomn_counter++){
...
Std_ReturnType keypad_get_value(const keypad_t *_keypad_object, uint8 *value){
    ...
    if(((void*)0) == _keypad_object || ((void*)0) == value){
        ret = (Std_ReturnType)0x00;
    }else{
        for(l_row_counter = 0; l_row_counter<4 ; l_row_counter++){
