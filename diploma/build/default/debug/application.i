...
# 38 "./ECU_Layer/Relay/ecu_relay.h"
...
# 41 "./ECU_Layer/dc_motor/ecu_dc_motor.h"
...
# 27 "./ECU_Layer/7_Segment/ecu_seven_seg.h"
typedef enum{
...
# 44 "./ECU_Layer/7_Segment/ecu_seven_seg.h"
...
typedef struct{
    ...
    pin_config_t keypad_colomn_pins[4];
}keypad_t;
...
# 31 "./MCAL_Layer/ADC/hal_adc_cfg.h"
...
# 60 "./MCAL_Layer/Timer1/hal_timer1.h"
typedef struct{
...
Std_ReturnType CCP_Capture_Start(const ccp_t *_ccp_obj);
...
# 1 "./MCAL_Layer/USART/usart_cfg.h" 1
...
typedef struct{
    void (*EUSART_SYNC_MASTER_TRANSMIT_InterruptHandler)(void);
}usart_sync_t;
...
Std_ReturnType EUSART_SYNC_MASTER_Tx_Init(const usart_sync_t *_eusart);
Std_ReturnType EUSART_SYNC_TX_WRITE_DATA(uint8 _data);
# 27 "./application.h" 2
